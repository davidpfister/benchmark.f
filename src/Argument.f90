!> @file
!! @defgroup group_arg Argument
!! @link benchmark_argument::arg Argument @endlink module
module benchmark_argument
    ...
    !> Represents the extended type for method @link benchmark_argument_base::arg_base argument @endlink
    !! <h2>Examples</h2>
